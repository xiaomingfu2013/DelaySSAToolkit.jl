using DelaySSAToolkit, DiffEqJump, Catalyst
# Gon, Goff, N, M, P
#     k10, Gon + P --> Goff
#     k01, Goff  --> Gon + P
...
delay_interrupt = Dict(5=>delay_interrupt_affect!)
...
delay_sol.u[2][3] == length(delay_sol.channel[2][2])
